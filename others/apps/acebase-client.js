...
class WebApi extends acebase_core_1.Api {
    ...
    set(path, value, options = {
        ...
        Promise.all([tryCachePromise, tryServerPromise])
            ...
            var _a, _b;
            const retryableError = serverPromise && !(serverResult === null || serverResult === void 0 ? void 0 : serverResult.success) && (((_a = serverResult === null || serverResult === void 0 ? void 0 : serverResult.error) === null || _a === void 0 ? void 0 : _a.isNetworkError) === true || ((_b = serverResult === null || serverResult === void 0 ? void 0 : serverResult.error) === null || _b === void 0 ? void 0 : _b.isServerError) === true);
            ...
            const gotValue = (source, val) => {
                ...
                if (source === 'server') {
                    ...
                    if (!wait) {
                        ...
                        const error = new errors_1.CachedValueUnavailableError(path, `Value for "${path}" not found in cache, and server value could not be loaded because of error ${serverError.code}: ${serverError.message}`);
...
},{"./base64":4,"./errors":6,"./promise-timeout":9,"./request":10,"./request/error":11,"acebase-core":25,"socket.io-client":42}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class AceBaseClientAuth {
     ...
     */
    async signInWithRedirect(providerName, options) {
        var _a;
        if (typeof window === 'undefined') {
            throw new Error(`signInWithRedirect can only be used within a browser context`);
        }
        const redirectUrl = await this.startAuthProviderSignIn(providerName, (_a = options === null || options === void 0 ? void 0 : options.callbackUrl) !== null && _a !== void 0 ? _a : window.location.href);
...
},{"./request/error":11}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Transport = exports.PartialArray = exports.proxyAccess = exports.ID = exports.ObjectCollection = exports.TypeMappings = exports.PathReference = exports.EventSubscription = exports.EventStream = exports.DataReferencesArray = exports.DataSnapshotsArray = exports.DataSnapshot = exports.DataReference = exports.AceBaseRequestError = exports.CachedValueUnavailableError = exports.ServerDate = exports.AceBaseUser = exports.AceBaseClientAuth = exports.AceBaseClient = void 0;
/**
...
Object.defineProperty(exports, "AceBaseRequestError", { enumerable: true, get: function () { return errors_1.AceBaseRequestError; } });
...
class AceBaseBase extends simple_event_emitter_1.SimpleEventEmitter {
    ...
    constructor(dbname, options = {}) {
        ...
        const legacyLogger = new debug_1.DebugLogger(options.logLevel, `[${dbname}]`);
        this.debug = legacyLogger; // For backward compatibility
        this.logger = (_a = options.logger) !== null && _a !== void 0 ? _a : legacyLogger;
        ...
        if (!options.sponsor) {
            ...
            info && legacyLogger.write(info.colorize(simple_colors_1.ColorStyle.magenta));
        }
...
},{"./data-reference":21,"./debug":23,"./optional-observable":27,"./simple-colors":34,"./simple-event-emitter":35,"./type-mappings":39}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Api = void 0;
...
},{"./data-reference":21,"./data-snapshot":22,"./id":24,"./optional-observable":27,"./path-info":29,"./path-reference":30,"./process":31,"./simple-event-emitter":35,"./utils":40}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
        ...
        options.eventHandler = ev => {
            ...
            listeners.forEach(callback => {
                ...
                try {
                    ...
                    this.ref.db.logger.error(`Error executing "${ev.name}" event handler of realtime query on path "${this.ref.path}": ${(_b = (_a = err === null || err === void 0 ? void 0 : err.stack) !== null && _a !== void 0 ? _a : err === null || err === void 0 ? void 0 : err.message) !== null && _b !== void 0 ? _b : err}`);
                }
            });
        };
...
},{"./data-proxy":20,"./data-snapshot":22,"./id":24,"./optional-observable":27,"./path-info":29,"./subscription":37}],22:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./acebase-base":14,"./api":15,"./ascii85":16,"./data-proxy":20,"./data-reference":21,"./data-snapshot":22,"./debug":23,"./id":24,"./object-collection":26,"./partial-array":28,"./path-info":29,"./path-reference":30,"./schema":32,"./simple-cache":33,"./simple-colors":34,"./simple-event-emitter":35,"./simple-observable":36,"./subscription":37,"./transport":38,"./type-mappings":39,"./utils":40}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./simple-observable":36,"./utils":40,"rxjs":41}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ascii85":16,"./partial-array":28,"./path-info":29,"./path-reference":30,"./utils":40}],39:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./data-reference":21,"./data-snapshot":22,"./path-info":29,"./utils":40}],40:[function(require,module,exports){
...
},{"./partial-array":28,"./path-reference":30,"./process":31,"buffer":41}],41:[function(require,module,exports){
